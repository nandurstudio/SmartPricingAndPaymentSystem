                        ...
                        <div class="page-header-content">
                            <div class="row align-items-center justify-content-between pt-3">
                                ...
                                <div class="col-12 col-xl-auto mb-3">
                                    <a class="btn btn-sm btn-light text-primary" href="<?= base_url('product/add'); ?>">
                            ...
                            <table id="datatablesSimple">
                                ...
                                <tbody>
                                    <?php foreach ($products as $product) : ?>
                                        <tr>
                                            <td><?= esc($product['txtProductName']); ?></td>
                                            <td><?= esc($product['txtProductDescription']); ?></td>
                                            <td>
                                                <?php if ($product['bitActive']) : ?>
                                                    <span class="badge bg-success">Active</span>
                                                <?php else : ?>
                                                    <span class="badge bg-danger">Inactive</span>
                                                <?php endif; ?>
                                            </td>
                                            <td><?= date('d M Y', strtotime($product['dtmCreatedDate'])); ?></td>
                                            <td><?= date('d M Y', strtotime($product['dtmLastUpdatedDate'])); ?></td>
                                            <td>
                                                <a class="btn btn-datatable btn-icon btn-transparent-dark me-2" href="<?= base_url('product/edit/' . $product['intProductID']); ?>"><i data-feather="edit"></i></a>
                                                <a class="btn btn-datatable btn-icon btn-transparent-dark" href="<?= base_url('product/delete/' . $product['intProductID']); ?>" onclick="return confirm('Are you sure want to delete this product?');"><i data-feather="trash-2"></i></a>
                                            </td>
                                        </tr>
                                    <?php endforeach; ?>
                                </tbody>
