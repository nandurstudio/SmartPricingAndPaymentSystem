        ...
        <div id="layoutSidenav_content">
            <main>
                        ...
                        <div class="page-header-content">
                            <div class="row align-items-center justify-content-between pt-3">
                                ...
                                <div class="col-12 col-xl-auto mb-3">
                                    <a class="btn btn-sm btn-light text-primary" href="<?= base_url('product'); ?>">
                ...
                <div class="container-fluid px-4">
                    <div class="card">
                        <div class="card-body">
                            <form action="<?= base_url('product/update/' . $product['intProductID']); ?>" method="POST">
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="txtProductName">Product Name</label>
                                            <input type="text" class="form-control" id="txtProductName" name="txtProductName" value="<?= esc($product['txtProductName']); ?>" required maxlength="255">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="checkbox" id="bitActive" name="bitActive" value="1" <?= $product['bitActive'] == 1 ? 'checked' : ''; ?>>
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control" id="txtProductDescription" name="txtProductDescription" rows="3"><?= esc($product['txtProductDescription']); ?></textarea>
                                        </div>
                                    </div>
                                    <div class="col-md-12">
