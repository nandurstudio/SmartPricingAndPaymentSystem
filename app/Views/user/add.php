                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="txtFullName" name="txtFullName" value="<?= old('txtFullName'); ?>" required>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="txtUserName">Username</label>
                                            <input type="text" class="form-control" id="txtUserName" name="txtUserName" value="<?= old('txtUserName'); ?>" required maxlength="50">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="email" class="form-control" id="txtEmail" name="txtEmail" value="<?= old('txtEmail'); ?>" required>
                                        </div>
                                    </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" id="intRoleID" name="intRoleID" required>
                                                ...
                                                <?php foreach ($roles as $roleItem) : ?>
                                                    <option value="<?= $roleItem['intRoleID'] ?>" <?= set_select('intRoleID', $roleItem['intRoleID']); ?>>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <small>Leave blank if you don't want to add a photo.</small>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="checkbox" id="bitActive" name="bitActive" value="1" <?= old('bitActive') == 1 ? 'checked' : ''; ?>>
