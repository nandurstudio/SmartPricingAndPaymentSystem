        ...
        <ul class="navbar-nav align-items-center ms-auto">
            ...
            <li class="nav-item dropdown no-caret d-none d-sm-block me-3 dropdown-notifications">
                ...
                <div class="dropdown-menu dropdown-menu-end border-0 shadow animated--fade-in-up" aria-labelledby="navbarDropdownMessages">
                    ...
                    <!-- Example Message 1  -->
                    <a class="dropdown-item dropdown-notifications-item" href="#!">
                        <img class="dropdown-notifications-item-img" src="<?= base_url('assets/img/illustrations/profiles/profile-' . rand(1, 6) . '.png'); ?>" />
                        <div class="dropdown-notifications-item-content">
            ...
            <li class="nav-item dropdown no-caret dropdown-user me-3 me-lg-4">
                <a class="btn btn-icon btn-transparent-dark dropdown-toggle" id="navbarDropdownUserImage" href="javascript:void(0);" role="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                    <?php
                    $photo = session('photo');
                    $photoUrl = ($photo === 'default.png') ? base_url('assets/img/illustrations/profiles/profile-1.png') : $photo;
                    ?>
                    <img class="img-fluid" src="<?= esc($photoUrl) ?>" alt="Profile Photo">
                </a>
                <div class="dropdown-menu dropdown-menu-end border-0 shadow animated--fade-in-up" aria-labelledby="navbarDropdownUserImage">
                    <h6 class="dropdown-header d-flex align-items-center">
                        ...
                        if ($photo === 'default.png') {
                            $photo = base_url('assets/img/illustrations/profiles/profile-1.png');
                        }
                        ?>
                        <img class="dropdown-user-img" src="<?= esc($photo) ?>" alt="Profile Photo" />
            ...
            <nav class="sidenav shadow-right sidenav-light">
                <div class="sidenav-menu">
                    <div class="nav accordion" id="accordionSidenav">
                        ...
                        <a class="nav-link active" href="javascript:void(0);" data-bs-toggle="collapse" data-bs-target="#collapseApps" aria-expanded="false" aria-controls="collapseApps">
                            <div class="nav-link-icon"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-globe">
                        ...
                        <div class="collapse show" id="collapseApps" data-bs-parent="#accordionSidenav">
                            <nav class="sidenav-menu-nested nav accordion" id="accordionSidenavAppsMenu">
                                ...
                                <div class="collapse show" id="appsCollapseUserManagement" data-bs-parent="#accordionSidenavAppsMenu">
                                    <nav class="sidenav-menu-nested nav">
                                        <a class="nav-link active" href="user-management-list.html">Users List</a>
                ...
                <div class="sidenav-footer">
                    <div class="sidenav-footer-content">
                        ...
                        <?php if (session()->get('isLoggedIn')): ?>
                            <div class="sidenav-footer-title"><?= esc(session()->get('userName')); ?></div>
                        <?php else: ?>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="txtUserName" name="txtUserName" value="<?= esc($user['txtUserName']); ?>" required maxlength="50">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="password" class="form-control" id="txtPassword" name="txtPassword" placeholder="Leave blank if not changing" minlength="6">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="txtRoleID">Role</label>
                                            <select class="form-control" id="intRoleID" name="intRoleID">
                                                <option value="">Select Role</option>
                                                <?php foreach ($roles as $roleItem) : ?>
                                                    <option value="<?= $roleItem['intRoleID'] ?>" <?= set_select('txtRoleID', $roleItem['intRoleID'], ($roleItem['intRoleID'] == $user['intRoleID']) ? true : false) ?>>
                                                        <?= $roleItem['txtRoleName'] ?>
                                                    </option>
                                                <?php endforeach; ?>
                                            </select>
                                        </div>
                                                ...
                                                <div class="mb-3">
                                                    <img src="<?php
                                                                if (!empty($user['txtPhoto']) && $user['txtPhoto'] !== 'default.png') {
                                                                    echo (filter_var($user['txtPhoto'], FILTER_VALIDATE_URL))
                                                                        ? esc($user['txtPhoto'])
                                                                        : base_url('uploads/photos/' . esc($user['txtPhoto']));
                                                                } else {
                                                                    echo base_url('assets/img/illustrations/profiles/profile-' . rand(1, 6) . '.png');
                                                                }
                                                                ?>" alt="Avatar" class="avatar-img img-fluid" width="100">
                                                </div>
                                            <?php endif; ?>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="bitActive">Status</label>
                                            <!-- Hidden input to ensure bitActive is always sent with a value -->
                                            <input type="hidden" name="bitActive" value="0">
                                            <input type="checkbox" id="bitActive" name="bitActive" value="1" <?= $user['bitActive'] == 1 ? 'checked' : ''; ?>>
