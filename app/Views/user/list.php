        ...
        <ul class="navbar-nav align-items-center ms-auto">
            ...
            <li class="nav-item dropdown no-caret d-none d-sm-block me-3 dropdown-notifications">
                ...
                <div class="dropdown-menu dropdown-menu-end border-0 shadow animated--fade-in-up" aria-labelledby="navbarDropdownMessages">
                    ...
                    <!-- Example Message 1  -->
                    <a class="dropdown-item dropdown-notifications-item" href="#!">
                        <img class="dropdown-notifications-item-img" src="<?= !empty($user['txtPhoto']) && $user['txtPhoto'] !== 'default.png' ? esc($user['txtPhoto']) : base_url('assets/img/illustrations/profiles/profile-' . rand(1, 6) . '.png'); ?>" />
                        <div class="dropdown-notifications-item-content">
                        ...
                        <div class="page-header-content">
                            <div class="row align-items-center justify-content-between pt-3">
                                ...
                                <div class="col-12 col-xl-auto mb-3">
                                    <a class="btn btn-sm btn-light text-primary" href="<?= base_url('user/add'); ?>">
                            ...
                            <table id="datatablesSimple">
                                ...
                                <tbody>
                                    ...
                                    usort($users, function ($a, $b) {
                                        return strtotime($b['dtmLastLogin'] ?? '1970-01-01') - strtotime($a['dtmLastLogin'] ?? '1970-01-01');
                                    });
                                    ?>
                                        ...
                                        <tr>
                                            <td>
                                                <img src="<?php
                                                            ...
                                                            ?>" alt="Avatar" class="avatar-img img-fluid" width="40">
                                            </td>
                                            <td><?= esc($user['txtFullName']); ?></td>
                                            <td><?= esc($user['txtEmail']); ?></td>
                                            <td><?= !empty($user['txtRoleName']) ? esc($user['txtRoleName']) : '-'; ?></td>
                                            <td><?= date('d M Y', strtotime($user['dtmJoinDate'])); ?></td>
                                            <td><?= $user['dtmLastLogin'] ? date('d M Y H:i', strtotime($user['dtmLastLogin'])) : '-'; ?></td>
                                            <td>
                                            ...
                                            <td>
                                                <a class="btn btn-datatable btn-icon btn-transparent-dark me-2" href="<?= base_url('user/edit/' . $user['intUserID']); ?>"><i data-feather="edit"></i></a>
                                                <!-- <a class="btn btn-datatable btn-icon btn-transparent-dark" href="<?= base_url('user/delete/' . $user['intUserID']); ?>" onclick="return confirm('Are you sure want to delete this user?');"><i data-feather="trash-2"></i></a> -->
                                            </td>
                                        </tr>
                                    <?php endforeach; ?>
                                </tbody>
