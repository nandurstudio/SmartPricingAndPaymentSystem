...
<head>
    ...
    <title>Add Product - SB Admin Pro</title>
                        ...
                        <div class="page-header-content">
                            <div class="row align-items-center justify-content-between pt-3">
                                ...
                                <div class="col-12 col-xl-auto mb-3">
                                    <a class="btn btn-sm btn-light text-primary" href="<?= base_url('category/add'); ?>">
                            ...
                            <table id="datatablesSimple">
                                ...
                                <tbody>
                                    <?php foreach ($categories as $category) : ?>
                                        <tr>
                                            <td><?= esc($category['txtCategoryName']); ?></td>
                                            <td>
                                                <?php if ($category['bitActive']) : ?>
                                                    <span class="badge bg-success">Active</span>
                                                <?php else : ?>
                                                    <span class="badge bg-danger">Inactive</span>
                                                <?php endif; ?>
                                            </td>
                                            <td><?= date('d M Y', strtotime($category['dtmCreatedDate'])); ?></td>
                                            <td><?= date('d M Y', strtotime($category['dtmLastUpdatedDate'])); ?></td>
                                            <td>
                                                <a class="btn btn-datatable btn-icon btn-transparent-dark me-2" href="<?= base_url('category/edit/' . $category['intCategoryID']); ?>"><i data-feather="edit"></i></a>
                                                <a class="btn btn-datatable btn-icon btn-transparent-dark" href="<?= base_url('category/delete/' . $category['intCategoryID']); ?>" onclick="return confirm('Are you sure want to delete this category?');"><i data-feather="trash-2"></i></a>
                                            </td>
                                        </tr>
                                    <?php endforeach; ?>
                                </tbody>
