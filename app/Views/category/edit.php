        ...
        <div id="layoutSidenav_content">
            <main>
                        ...
                        <div class="page-header-content">
                            <div class="row align-items-center justify-content-between pt-3">
                                ...
                                <div class="col-12 col-xl-auto mb-3">
                                    <a class="btn btn-sm btn-light text-primary" href="<?= base_url('category'); ?>">
                ...
                <div class="container-fluid px-4">
                    <div class="card">
                        <div class="card-body">
                            <form action="<?= base_url('category/update/' . $category['intCategoryID']); ?>" method="POST">
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="txtCategoryName">Category Name</label>
                                            <input type="text" class="form-control" id="txtCategoryName" name="txtCategoryName" value="<?= esc($category['txtCategoryName']); ?>" required maxlength="100">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="checkbox" id="bitActive" name="bitActive" value="1" <?= $category['bitActive'] == 1 ? 'checked' : ''; ?>>
