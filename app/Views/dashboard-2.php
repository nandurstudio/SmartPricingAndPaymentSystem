...
<body class="nav-fixed">
    <nav class="topnav navbar navbar-expand shadow justify-content-between justify-content-sm-start navbar-light bg-white" id="sidenavAccordion">
        ...
        <a class="navbar-brand pe-3 ps-4 ps-lg-2" href="index.html">Kelompok 5</a>
        <!-- Navbar Search Input-->
                    ...
                    <div class="nav accordion" id="accordionSidenav">
                        ...
                        <div class="collapse show" id="collapseDashboards" data-bs-parent="#accordionSidenav">
                            <nav class="sidenav-menu-nested nav accordion" id="accordionSidenavPages">
                                ...
                                <a class="nav-link active" href="dashboard-2.html">Multipurpose</a>
                            ...
                            <div class="row align-items-center justify-content-between">
                                <div class="col-auto mt-4">
                                    <h1 class="page-header-title">
                                        ...
                                        Dashboard Tugas UTS Kelompok 5
                                    </h1>
                                    <div class="page-header-subtitle">Pemrograman Web 2 - Universitas Pelita Bangsa</div>
                                </div>
                            </div>
                        </div>
                    </div>
